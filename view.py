...
def admin_menu():
    ...
    print('        **    **  **  **  **  ******   *****  ***  **       ')
    print('------------------------------------------------------------')
    print('           1. BALANCE        |     2. VIEW ACCOUNTS         ')                           
    print('------------------------------------------------------------')
    print('           3. MASTER INFO    |     4. LOGOUT                ')
    print('------------------------------------------------------------')
...
def accounts_master_menu():
    ...
    print('        **    **  **  **  **  ******   *****  ***  **       ')
    print('------------------------------------------------------------')
    print('  1. BALANCES |  2. POSITIONS  |  3. HISTORY  |  4. RETURN  ')                           
    print('------------------------------------------------------------')
